...
export default function Login() {
  ...
  return (
    <div style={{ maxWidth: '420px', margin: '4rem auto', padding: '0 1.5rem' }}>
      <div className="card">
        <h2 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.4rem', textAlign: 'center' }}>Candidate Login</h2>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', textAlign: 'center', marginBottom: '1.8rem' }}>
          Log in to access your contests &amp; assessments
        </p>
        ...
        <p style={{ textAlign: 'center', fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: '1.5rem' }}>
          Don't have an account? <Link to="/register" style={{ color: 'var(--accent2)', fontWeight: 600 }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
